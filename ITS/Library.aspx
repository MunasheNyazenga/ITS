<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.master" AutoEventWireup="true" CodeBehind="Library.aspx.cs" Inherits="ITS.Library" %>
               ...
               <!-- Content Row -->
                    ...
                    <div class="row">
                        ...
                        <div style="min-width: 100%">
                            ...
                            <asp:GridView ID="GridView1" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" AllowPaging="True"  PageSize="5">
