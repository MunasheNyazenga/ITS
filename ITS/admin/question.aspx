<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="True" CodeBehind="question.aspx.cs" Inherits="admin_question" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" Runat="Server">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group">
                <asp:Button ID="btn_panelallquestion" runat="server" Text="All Questions" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" BackColor="#4e73df" />
            </div>
        </div>
