<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="True" CodeBehind="studentList.aspx.cs" Inherits="admin_studentList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="Server">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group">
                <asp:Button ID="btn_panelresult" runat="server" Text="All Students" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" BackColor="#4e73df" />
            </div>
