<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="True" CodeBehind="exam.aspx.cs" Inherits="admin_exam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="Server">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group">
                <asp:Button ID="btn_panelexamlist" runat="server" Text="View Exam List" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" OnClick="btn_panelexamlist_Click" />
            ...
            <asp:Panel ID="panel_addexam" runat="server">
                <div class="card-body">
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Select Assessment</label>
                        <div class="col-md-4">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Exam Duration (Minutes)</label>
                        <div class="col-md-4">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Exam Pass Mark</label>
                        <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <asp:GridView ID="grdview_examlist" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" OnRowCommand="grdview_examlist_RowCommand" AllowPaging="True" OnPageIndexChanging="grdview_examlist_PageIndexChanging" PageSize="5">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="category_name" HeaderText="Assessment Name" />
                                    <asp:BoundField DataField="subject_name" HeaderText="Course Name" />
                                    ...
                                    <asp:TemplateField HeaderText="Options">
                                        <ItemTemplate>
                                            ...
                                            <i class="fa fa-plus" aria-hidden="true"></i> Add Question(s)
                                            </asp:HyperLink>
                                            ...
                                            <i class="fa fa-info-circle" aria-hidden="true"></i> View Question(s)
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
                                    There are no exams added at the moment. Add exam
                                </EmptyDataTemplate>
