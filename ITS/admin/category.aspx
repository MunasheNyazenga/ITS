<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="True" CodeBehind="category.aspx.cs" Inherits="admin_category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="Server">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group">
                <asp:Button ID="btn_panelcategorylist" runat="server" Text="View Assessment List" CssClass="btn btn-info" OnClick="btn_panelcategorylist_Click" BorderStyle="None" CausesValidation="False" />
                <asp:Button ID="btn_paneladdcategory" runat="server" Text="Add Assessment" CssClass="btn d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" OnClick="btn_paneladdcategory_Click" BorderStyle="None" CausesValidation="False" />
            </div>
            <%--Add category panel--%>
            <asp:Panel ID="panel_addcategory" runat="server">
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_addcategory" runat="server" Text="Add Assessment" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" OnClick="btn_addcategory_Click" />
                        </div>
