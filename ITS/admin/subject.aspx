<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="True" CodeBehind="subject.aspx.cs" Inherits="admin_subject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="Server">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group">
                <asp:Button ID="btn_panelsubjectlist" runat="server" Text="View Course List" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" OnClick="btn_panelsubjectlist_Click" />
                <asp:Button ID="btn_paneladdSubject" runat="server" Text="Add Course" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" OnClick="btn_paneladdSubject_Click" />
            </div>
            <%--Add subject panel--%>
            <asp:Panel ID="panel_addsubject" runat="server">
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Enter Assessment Name</label>
                        <div class="col-md-4">
                    ...
                    <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_addsubject" runat="server" Text="Add Course" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" OnClick="btn_addsubject_Click" />
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <asp:GridView ID="grdview_subjectlist" runat="server" GridLines="None" AutoGenerateColumns="False" CssClass="table table-bordered" OnRowCommand="grdview_subjectlist_RowCommand" AllowPaging="True" OnPageIndexChanging="grdview_subjectlist_PageIndexChanging" PageSize="5">
                                <Columns>
                                    <asp:BoundField DataField="subject_name" HeaderText="Course" />
                                    <asp:BoundField DataField="category_name" HeaderText="Assessment" NullDisplayText="The subject is under no category" />
